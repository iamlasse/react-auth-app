...
describe('Auth Reducer', () => {
   ...
   */
	...
	it('should handle LOGIN_REQUESTED', () => {
		expect(reducer({}, authActions.loginRequest(user.email, 'password'))).toEqual({ fetching: true });
	});
	...
	it('should handle LOGOUT_SUCESS', () => {
		expect(reducer({}, authActions.logoutSuccess())).toEqual({ authenticated: false, fetching: false });
	});
